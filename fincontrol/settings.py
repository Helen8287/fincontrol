...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'finances/static']
...
CRONJOBS = [
     ('0 9 * * *', 'finances.cron.send_daily_reports', '>> /tmp/fincontrol_cron.log 2>&1'),
     ('0 10 * * 1', 'finances.cron.send_weekly_reports', '>> /tmp/fincontrol_cron.log 2>&1'),
     ('0 */6 * * *', 'finances.cron.check_budgets', '>> /tmp/fincontrol_cron.log 2>&1'),
 ]
